...
public partial class DecretosDestapol
{
    ...
    public string? PaternoEvaluador { get; set; }

    public string? MaternoEvaluador { get; set; }
    ...
    public string SituacionInteroperatividad { get; set; } = null!;

    public string Deriva { get; set; } = null!;
    ...
    public string? EsVif { get; set; }

    public string? RiesgoVif { get; set; }
}
